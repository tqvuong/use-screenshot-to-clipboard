...
var _downloadImage = function (blobImage, nameOfDownload) {
    if (nameOfDownload === void 0) { nameOfDownload = 'my-image.png'; }
...
var useScreenshot = function (_a) {
    var _b = _a.type, type = _b === void 0 ? 'image/png' : _b, quality = _a.quality;
    var _c = useState(null), error = _c[0], setError = _c[1];
    var takeScreenShot = function (node, nameOfDownload) {
        return _htmlToBlob(node, type, quality)
            .then(function (blob) { return _downloadImage(blob, nameOfDownload); })
            .catch(setError);
    };
...
var useScreenshotToClipboard = function (_a) {
    ...
    var makeCopyToClipboard = function (node) {
        return _htmlToBlob(node, type, quality).then(_copyBlobToClipboard).catch(setError);
    };
    return [makeCopyToClipboard, error];
};

export { useScreenshotToClipboard as default, useScreenshot };
